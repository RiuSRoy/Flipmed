...
const docCurious = doctorController.registerDoc("1", "curious", Doctor_1.Speciality.CARDIO);
docs.add(docCurious);
console.log("\n");
...
console.log("\n");
const docDreadful = doctorController.registerDoc("2", "Dreadful", Doctor_1.Speciality.DERMA);
...
console.log("\n");
bookingController.showAvailByspeciality(Array.from(docs), Doctor_1.Speciality.CARDIO);
console.log("\n");
...
console.log("\n");
const docDaring = doctorController.registerDoc("3", "Daring", Doctor_1.Speciality.DERMA);
docs.add(docDaring);
console.log("\n");
...
console.log("\n");
bookingController.showAvailByspeciality(Array.from(docs), Doctor_1.Speciality.DERMA);
console.log("\n");
